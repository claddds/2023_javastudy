...
public class Ex02_Set {
	public static void main(String[] args) {
		/*
			...
			형식: HashSet<제네릭타입 = 객체타입 = 클래스> 참조 변수 = new HashSet<[제네릭 타입 = 객체 타입 = 클래스]>();
				 TreeSet<제네릭타입 = 객체타입 = 클래스> 참조 변수 = new TreeSet<[제네릭 타입 = 객체 타입 = 클래스]>();
		*/
		...
		h1.add(20);	// 오토 박싱: 기본자료형이 해당 객체로 만들어진다.
		...
		h3.add('a');
		h3.add('v');
		h3.add('a');	// 중복불가, 들어가지 않음(출력이 안되어있다)
