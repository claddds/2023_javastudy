...
public class Ex04_Cafe extends JFrame {
	public Ex04_Cafe() {
		...
		JRadioButton jrd1 = new JRadioButton("아메리카노(3000)");
		JRadioButton jrd2 = new JRadioButton("카페모카(4000)");
		JRadioButton jrd3 = new JRadioButton("카페라떼(3500)");
		JRadioButton jrd4 = new JRadioButton("과일쥬스(3000)");
