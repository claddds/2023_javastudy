...
public class Ex04_ObjectOutputStream {
	public static void main(String[] args) {
		...
		Ex04_VO vo2 = new Ex04_VO("이길동", 23, "서울 용산구", false, 167.5);
		Ex04_VO vo3 = new Ex04_VO("김길동", 24, "서울 강남구", true, 170.5);
		Ex04_VO vo4 = new Ex04_VO("박길동", 21, "서울 서초구", false, 188.0);
		Ex04_VO vo5 = new Ex04_VO("홍길동", 29, "서울 중량구", true, 173.7);
		...
		// 직렬화가 된 정보는 정상적으로 볼 수 없다.
		// 읽을 때 역직렬화를 해야 볼 수 있다.
		String pathname = "D:/rhj/object02.ser";
