...
public class Ex03_ObjectOutputStream {
	public static void main(String[] args) {
		...
		Ex03_VO vo2 = new Ex03_VO("이길동", 23, "서울 용산구", false, 167.5);
		Ex03_VO vo3 = new Ex03_VO("김길동", 24, "서울 강남구", true, 170.5);
		Ex03_VO vo4 = new Ex03_VO("박길동", 21, "서울 서초구", false, 188.0);
		Ex03_VO vo5 = new Ex03_VO("홍길동", 29, "서울 중량구", true, 173.7);
		...
		String pathname = "D:/rhj/object01.ser";
