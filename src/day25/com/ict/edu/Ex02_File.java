...
public class Ex02_File {
	public static void main(String[] args) {
		String pathname = "D:/rhj/exam01.txt";
		...
		try {
			...
			File file2 = new File("D:/rhj/EXAM/AAA");
			...
			// 디렉토리 삭제
			File file4 = new File("D:/rhj/EXAM/AAA");
			boolean res4 = file4.delete();
			if(res4) {
				System.out.println("디렉토리 AAA삭제 성공");
				File file5 = new File("D:/rhj/EXAM");
