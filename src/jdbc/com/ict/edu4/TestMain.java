...
public class TestMain {
	public static void main(String[] args) {
		...
		case 1:
			...
			for (VO k : list) {
				System.out.println(k.get고객아이디() + "\t");
				System.out.println(k.get고객이름() + "\t");
				System.out.println(k.get나이() + "\t");
				System.out.println(k.get등급() + "\t");
				System.out.println(k.get직업() + "\t");
		...
		case 2:
			...
			if (vo.get고객아이디() != null) {
				System.out.println(vo.get고객아이디() + "\t");
				System.out.println(vo.get고객이름() + "\t");
				System.out.println(vo.get나이() + "\t");
				System.out.println(vo.get등급() + "\t");
				System.out.println(vo.get직업() + "\t");
